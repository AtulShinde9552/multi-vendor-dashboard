...
import { get_area_manager_dashboard_index_data } from '../../store/Reducers/dashboardIndexReducer';
...
const AreaManagerDashboard = () => {
    ...
    useEffect(() => {
        dispatch(get_area_manager_dashboard_index_data());
    }, [dispatch]);
                        ...
                        <tbody>
                            {
                                recentOrders.map((d, i) => <tr key={i}>
                                    ...
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                        <Link to={`/area_manager/dashboard/order/details/${d._id}`}>view</Link>
                                    </td>
                                </tr>)
                            }
                        </tbody>
